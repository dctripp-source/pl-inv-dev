...
<section class="relative min-h-screen flex items-center">
    ...
    <div class="absolute inset-0 hidden md:block">
        <img src="storage/images/h13.jpg" alt="Pozadinska slika" class="w-full h-full object-cover">
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white">
                <h1 class="text-4xl md:text-5xl lg:text-5xl font-bold mb-6 leading-tight" style="color: #fff; line-height: 55px !important;">
                    {!! __sr('hero_title', 'Dobrodošli na <br> Biznis Mrežu INVRS', 'Добродошли на <br> Бизнис Мрежу ИНВРС') !!}
                </h1>
                
                <p class="text-xl md:text-2xl mb-8 leading-relaxed" style="color: #fff; font-size: 22px;">
                    {!! __sr('hero_subtitle', 'Zvanična platforma Fonda za profesionalnu rehabilitaciju i zapošljavanje invalida Republike Srpske, kreirana da <br> osnaži, poveže i promoviše preduzetnike sa invaliditetom.', 'Званична платформа Фонда за професионалну рехабилитацију и запошљавање инвалида Републике Српске, креирана да оснажи, повеже и промовише предузетнике са инвалидитетом.') !!}
                </p>
                
                <!-- CTA Button -->
                <div class="mb-12" style="margin-top: 7%;">
                    <a href="{{ route('business.create') }}" class="inline-block font-semibold px-8 py-4 rounded-full text-lg transition-colors duration-300 shadow-lg hover:shadow-xl text-white" style="background-color: #fff; color: #2265cd;" onmouseover="this.style.backgroundColor='#1c56b3'; this.style.color='#fff'" onmouseout="this.style.backgroundColor='#FFF'; this.style.color='#2265CD'">
...
<section class="py-16 bg-gray-50 flex items-center justify-center" style="height: 80vh; background-image: url('{{ asset('storage/images/bck4.jpg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" style="padding: 8px 24px; border-radius: 8px; display: inline-block; font-size: 42px;">
                {{ __sr('how_it_works', 'Ono što nas pokreće', 'Оно што нас покреће') }}
            </h2>
            <p style="font-size: 22px;">
                {{ __sr('how_it_works_desc', 'Principi koji vode našu zajednicu ka uspješnoj budućnosti', 'Принципи који воде нашу заједницу ка успјешнoj будућности') }}
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <p class="text-gray-600 leading-relaxed">
                    {{ __sr('step2_desc', 'Republika Srpska kao primer inkluzivnog preduzetništva u regionu. Društvo gdje se različitost cijeni i gdje svaki biznis može da napreduje.', 'Република Srpska као пример инклузивног предузетништва у региону. Друштво гдје се различитост цијени и гдје сваки бизнис може да напредује.') }}
                </p>
            </div>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" style="font-size: 42px;">{{ __sr('latest_businesses', 'Najnoviji Biznisi', 'Најновији Бизниси') }}</h2>
            <p class="text-xl text-gray-600" style="font-size: 22px;">{{ __sr('meet_newest_members', 'Upoznajte najnovije članove naše zajednice', 'Упознајте најновије чланове наше заједнице') }}</p>
        </div>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('business.show', $business->slug) }}" 
                           class="bg-primary text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm" style="font-size: 16px;">
        ...
        <div class="text-center mt-8" style="margin-top: 5%;">
            <a href="{{ route('business.index') }}" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition-colors" style="background-color: #2265cd; font-size: 18px;">
...
<section class="py-16 bg-white" style="height: auto; background-image: url('{{ asset('storage/images/bck4.jpg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" style="font-size: 42px;">{{ __sr('popular_categories', 'Popularne Kategorije', 'Популарне Категорије') }}</h2>
            <p class="text-xl text-gray-600" style="font-size: 22px;">{{ __sr('explore_categories', 'Istražite različite vrste biznisa', 'Истражите различите врсте бизниса') }}</p>
        </div>
        ...
        <div class="text-center mt-8" style="margin-top: 5%;">
            <a href="{{ route('category.index') }}" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors" style="font-size: 18px;">
